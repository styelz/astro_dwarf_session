...
def overview_session_tab(parent_frame, refresh_setter=None):
    ...
    select_button = tk.Button(parent_frame, text="Toggle Selected", command=lambda: select_session_with_position_restore(json_listbox, json_text, refresh_json_list), state=tk.NORMAL)
